[
  ...
  //Lemon and blackberry stripe cake///////////////////
  {
    ...
    time: 'Hands-on time 1 hour 40 min, plus cooling. Oven time 2 hours 15 min',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'american',
    description:
  ...
  //Paul Hollywood’s chocolate fudge cake///////////////////
  {
    ...
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'american',
    description:
    ...
    method: [
      {
        'Step 1':
          'Using a stand mixer fitted with the whisk attachment or electric hand mixer, beat the margarine and sugars together until the mixture is pale and fluffy – this will take around 5 minutes. Scrape down the sides of the bowl with a spatula and whisk again.',
      },
      {
        'Step 2':
          'In a separate bowl, beat the eggs with the vanilla extract. With the mixer still running on a low-medium speed, slowly pour the beaten eggs into the mixture.',
      },
      {
        'Step 3':
          'Sift the flour with the cocoa powder, baking powder and salt. Stir a large spoonful into the whisked mixture, then mix in a large spoonful of the soured cream. Repeat until all the flour and soured cream are incorporated. Beat until you have a smooth batter.',
      },
      {
        'Step 4':
          'Heat the oven to 160°C fan/gas 4. Grease 3 x 20cm loose-bottomed sandwich tins and line the bases with baking paper. Divide the batter equally among the prepared tins. Bake for 25-30 minutes until the cakes are risen and slightly shrunk away from the sides of the tin. Leave to cool in the tins before transferring to a wire rack to cool completely.',
      },
      {
        'Step 5':
          'To make the frosting, melt the chocolate in a heatproof bowl set over a pan of simmering water, making sure the base of the bowl is not in contact with the water. Stir until smooth, then set aside to cool. In another bowl, mix the cocoa powder with the boiling water to make a thick paste.',
      },
      {
        'Step 6':
          'In a large bowl, beat the butter until soft and fluffy, then add the icing sugar and whisk until pale and fluffy. Add the melted chocolate and cocoa paste and beat until the frosting is smooth.',
      },
      {
        'Step 7':
    ...
    image:
      'https://www.recipetineats.com/wp-content/uploads/2018/11/Easy-Chocolate-Fudge-Cake_3a.jpg',
  },
  //Lemon and strawberry meringue cake///////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 12-14',
    time: 'Hands-on time 45 minutes. Oven time 1 hour 20 minutes, plus cooling.',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'american',
    description:
    ...
    method: [
      ...
      {
        'Step 5':
          'Bake for 1 hour, then turn off the oven and let the meringue cool for 30 minutes in the oven with the door ajar. Remove and allow to cool completely, then remove the ring, using a sharpknife to detach it first.',
      },
      {
        'Step 6':
          'To assemble, whip the cream until soft peaks (that flop over) form. Put one cake layer on a cake stand, spread with a third of the lemon curd, then half the cream and half the sliced berries. Top with another cake layer, then repeat with another third of the curd and the remaining cream and sliced berries. Finish with the final cake layer and most of the remaining curd, then add the meringue crown. Dot the rest of the curd over the meringue, then decorate with the strawberry halves. Serve in slices.',
      },
    ],
  ...
  {
    id: '6',
    title: 'Spiced plum cake with swiss meringue frosting',
    difficulty: 'Easy',
    portion: 'Serves 8-10',
  ...
  //Lemon and courgette cake with white chocolate cream cheese frosting///////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 12-14',
    time: 'Hands-on time 1 hour, plus chilling and cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'american',
    description:
    ...
    ingredients: [
      '375g unsalted butter, softened300g caster sugar5 medium free-range eggs, at room temperature375g self-raising four1 tsp bicarbonate of soda2 tsp ground ginger300g courgettes, grated (see Know How)Grated zest 4 lemonsCandied lemon slices to decorate (see Know How and use the zested lemons above)',
      ...
      '115g caster sugar3 medium free-range eggs, plus 2 medium free-range egg yolks1 tbsp cornflourGrated zest and juice 2 large lemons (about 150ml juice)75g cold unsalted butter, diced',
      '115g caster sugar',
      ...
      '375g unsalted butter, softened and at room temperature200g icing sugar300g full-fat cream cheese (we used Philadelphia) at room temperature150g white chocolate, melted and cooledSqueeze of lemon juice',
      '375g unsalted butter, softened and at room temperature',
      '200g icing sugar',
    ...
    method: [
      ...
      {
        'Step 2':
          'Sift together the flour, bicarb and ginger, then gently fold into the wet mixture using a figure-of-eight motion until just combined. Finally, gently fold in the courgettes and lemon zest. Divide the batter evenly between the prepared tins, smooth the tops, then bake for 25-30 minutes until golden and a skewerpushed into the middle comes out clean. Cool in the tins for 10 minutes, then turn out onto a wire rack and set aside to cool completely (see Make Ahead).',
      },
      {
        'Step 3':
  ...
  //Chocolate cake with caramel poached pears and chocolate buttercream///////////////////
  {
    ...
    time: 'Hands-on time 30 min, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'american',
    description:
  ...
  //Spring lamb cupcakes////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Makes 12',
    time: 'Hands-on time 40 min, oven time 15-18 min, plus cooling',
    category: [
      'dessert',
      'cupcakes',
      'holidays',
    ...
    method: [
      {
        'Step 1':
          'To make the cupcakes, heat the oven to 190°C/170°C fan/gas 5. Put the butter, sugar, flour, eggs, milk and vanilla extract in a large mixing bowl and beat using an electric mixer until light and fluffy. Divide the mixture among the cupcake cases in the tin and bake for 15-18 minutes or until the cakes have risen and spring back when lightly pressed in the centre. Remove from the oven and transfer to a wire rack to cool.',
      },
      {
        'Step 2':
          'To make the sheep faces, break off a small piece of black sugarpaste (about 10g in weight), then knead to soften and shape into an oval. Slightly flatten the oval, shape to make one end slightly narrower than the other (to create the forehead and chin), then set aside.',
      },
      {
        'Step 3':
          'Take 2 smaller pieces of black sugarpaste, knead gently, then flatten into little ovals for the ears. Press these onto either side of the wider part of the head (see tips).',
      },
      {
        'Step 4':
          'To make the eyes, take 2 small balls of white sugarpaste and press them onto the head, flattening them slightly. Then make 2 very tiny balls of black sugarpaste and press onto the eyes (or see tips). If you like, make a small long cone shape from the black sugarpaste and flatten it slightly for a tail.',
      },
      {
        'Step 5':
          'To make the buttercream frosting, put the butter in a large mixing bowl and add the icing sugar, vanilla extract and 1 tbsp boiling water. Beat well until smooth, light and fluffy.',
      },
      {
        'Step 6':
          'Working on one cake at a time, spread buttercream over the top of a cake and stick on a head, then press white mini marshmallows around it, all over the top. Stick on the tail, if using. Let the children pile in…',
      },
    ],
  ...
  {
    id: '11',
    title: 'Peanut butter drip cake',
    difficulty: 'Medium',
    portion: 'Serves 20',
    time: 'Hands-on time 1½ hours, oven time 20-25 min, plus chilling ',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'american',
    description:
    ...
    method: [
      {
        'Step 1':
          'Heat the oven to 170°C/150°C fan/gas 3½. Put the cocoa powder, 100g of the muscovado sugar and the espresso powder into a large measuring jug. Pour in the boiling water and whisk with a balloon whisk until smooth.',
      },
      {
        'Step 2':
      ...
      {
        'Step 4':
          'Divide the batter equally between the prepared tins and level using a spatula. Bake for 20-25 minutes until the sponges have risen and a skewer inserted into the centre comes out clean. Cool for 5 minutes in the tin, then turn out onto a wire rack to cool completely.',
      },
      {
        'Step 5':
      ...
      {
        'Step 7':
          'Cover the cake with the rest of the icing in a smooth layer, then return to the fridge while you make the ganache.',
      },
      {
        'Step 8':
          'For the ganache, put the chocolate in a large heatproof bowl and put the cream in a pan set over a medium heat. Slowly bring the cream to the boil. As soon as it starts to bubble, pour over the chocolate and leave to stand for 2 minutes. Stir until the chocolate has completely melted, then transfer the ganache to a piping bag.',
      },
      {
        'Step 9':
          'Snip a small hole at the bottom of the piping bag and pipe the ganache steadily and generously around the edge of the cake so that some of it runs down the side creating the ‘drips’. Once you’re happy with the drips, cover the top of the cake with the remaining ganache. Smooth with a palette knife, then return to the fridge to set for 30 minutes.',
      },
      {
        'Step 10':
          'Decorate with a selection of your favourite chocolates or sweets – we went for Oreos, M & M’s and Kit Kats. Be creative!',
      },
    ],
    image: 'https://apipics.s3.amazonaws.com/cakes_api/11.jpg',
  },
  //Ginger drizzle traybake with cream cheese icing////////////////////
  {
    id: '12',
    title: 'Ginger drizzle traybake with cream cheese icing',
    difficulty: 'Easy',
    portion: 'Makes 16',
    time: 'Hands-on time 15 min, oven time 40-45 min',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'french',
    description:
    ...
    ingredients: [
      ...
      '300g self-raising flour',
      '1 tbsp ground ginger, plus extra',
      '2 balls stem ginger in syrup, finely chopped, plus 2 tbsp syrup',
      '3 tbsp natural yogurt',
      'Finely grated zest and juice 1 lime',
      '1⁄2 tsp salt',
      '170g unsalted butter, softened',
      '170g golden icing sugar',
      '340g full-fat cream cheese (we used Philadelphia)',
      'Grated zest and juice 1 lime',
      'Small handful crystallised ginger (optional), chopped if large',
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/12.jpg',
  },
  //Baked lemon cheesecake with pineapple flowers////////////////////
  {
    ...
    difficulty: 'Medium',
    portion: 'Serves 10-12',
    time: 'HANDS-ON TIME 30 MIN, OVEN TIME 1 HOUR 35-45 MIN, PLUS CHILLING AND COOLING',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'american',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/13.jpg',
  },
  //Carrot and cheesecake layer cake////////////////////
  {
    id: '14',
    title: 'Carrot and cheesecake layer cake',
    difficulty: 'A challenge',
    portion: 'Serves 20 (at least)',
    time: 'Hands-on time 1 hour 20 min, oven time 60-70 min, plus cooling and up to 7 hours chilling ',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'american',
    description:
    ...
    method: [
      ...
      {
        'Step 2':
          'Once the cakes are out of the oven, reduce the oven temperature to 140°C/120°C fan/gas 1. Next, make the cheesecake layer. Grease and re-line one of the cake tins, then melt the chocolate in a heatproof bowl set over a pan of barely simmering water (don’t let the bowl touch the water) and set aside.',
      },
      {
        'Step 3':
          'Using a hand whisk, beat together the cream cheese and caster sugar in a mixing bowl until the sugar crystals have dissolved and the mixture is smooth. Add the cornflour and mix again until combined, then add the egg and whipping cream, mixing gently until smooth.',
      },
      {
        'Step 4':
          'Remove one third of the mixture to a clean mixing bowl and stir in the melted dark chocolate until fully combined. Mix the vanilla extract into the remaining mixture, then pour into the prepared cake tin. Spoon the chocolate mixture over the top and use a skewer to create a marbled pattern in the cheesecake mixture. Bake in the centre of the oven for 35 minutes until set but still with a slight wobble. Leave to cool completely in the tin, then transfer to the freezer to cool for an hour. If you don’t have room in the freezer, put in the fridge for 4-6 hours (or overnight – see Make Ahead). Chilling the cheesecake well will make the cake easier to assemble.',
      },
      {
        'Step 5':
          'To make the cream cheese frosting, using an electric hand mixer, beat the butter, icing sugar and golden syrup in a mixing bowl until light and fluffy, then gently beat in the cream cheese and vanilla extract.',
      },
      {
        'Step 6':
          'To assemble the cake, trim the domed top off each sponge to flatten them (it’s easiest to use a bread knife), then slice each cake in half horizontally to make 4 even layers. Put the bottom half of one sponge on a cake board or serving plate, then spread with a layer of cream cheese frosting about 0.5-1cm thick. Add the top half of the carrot cake, then a thinner coating of icing. Put the cheesecake layer on top and spread with another thin layer of icing. Top with the last 2 layers of carrot cake, with a thicker layer of icing between the two. Transfer to the fridge and leave to set for an hour, then cover the cake all over with the remaining icing. Decorate with edible flowers, if you like.',
      },
    ],
    image:
      'https://itsybitsykitchen.com/wp-content/uploads/2017/03/DSC_7939chubbyhubbycupcakes.jpg',
  },
  //Sugarplum fairy cakes////////////////////
  {
    id: '15',
    title: 'Sugarplum fairy cakes',
    difficulty: 'Medium',
    portion: 'Makes 12',
    time: 'Hands-on time 40-45 min, oven time 20-25 min, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'cupcakes', 'holidays', 'celebration'],
    cuisine: 'american',
    description:
      'Soft and fluffy fairy cakes are dotted with little nuggets of marzipan and come topped with buttercream and caramel shards. A cake fit for a fairy queen.',
    ingredients: [
      '120g unsalted butter, softened',
      '110g caster sugar',
      '2 large free-range eggs',
      '120g self-raising flour',
      '100g marzipan, chopped into 0.5cm square chunks',
      '150g caster sugar',
      '20 cardamom pods, seeds removed and crushed (pods discarded)',
    ...
    method: [
      {
        'Step 1':
          'Heat the oven to 180°C/160°C fan/gas 4 and line the cupcake tin with the cases. To make the sponge mixture, beat the butter and caster sugar together in a mixing bowl using an electric mixer until light and fluffy, then beat in the eggs one at a time. Reduce the mixing speed and beat in the flour with a pinch of salt until just combined. Stir the marzipan chunks into the batter using a metal spoon, then divide the mixture among the cases and bake for 20-25 minutes until risen, golden and springy. Remove from the tin and leave to cool on a wire rack.',
      },
      {
        'Step 2':
          'To make the caramel shards, line your largest baking tray with non-stick baking paper and put in a warm oven. Put the sugar in a spotlessly clean and dry frying pan, put over a low-medium heat and leave to melt (resist touching it).',
      },
      {
        'Step 3':
          'Once the sugar begins to melt, turn the heat up a little and keep an eye on it – if it starts to caramelise in places before all the sugar has melted, tilt the pan to move the sugar around. Once it’s completely liquid, remove the baking tray from the oven, turn up the heat under the pan and keep tilting the pan until all the sugar is deep golden. Immediately tip the caramel onto the baking tray and, working quickly, tip the tray to spread the hot mixture as thinly as possible. Scatter over the crushed cardamom and leave somewhere cool to harden.',
      },
      {
        'Step 4':
          'For the buttercream, put the butter in a mixing bowl and beat for a few minutes with an electric hand mixer until fluffy. Sift in the icing sugar in 3-4 additions, beating well after each one, until it forms a smooth icing. If it’s too stiff to pipe, beat in the milk, then quickly beat in the lemon zest. Transfer to a piping bag fitted with a star nozzle, if using.',
      },
      {
        'Step 5':
          'To decorate the fairy cakes, pipe swirls of icing, or spoon on and smooth with a palette knife. Use the point of a sharp knife to crack the caramel into shards, then use the prettiest for the cakes – stick them into the icing so they stand upright. Serve immediately.',
      },
    ],
    image: 'https://apipics.s3.amazonaws.com/cakes_api/15.jpg',
  },
  //Summer-cup bundt drizzle cake////////////////////
  {
    id: '16',
    title: 'Summer-cup bundt drizzle cake',
    difficulty: 'Easy',
    portion: 'Serves 12',
    time: 'Hands-on time 35 min, oven time 3 hours, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'american',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/16.jpg',
  },
  //St Clement’s squares////////////////////
  {
    id: '17',
    title: 'St Clement’s squares',
    difficulty: 'Easy',
    portion: 'Makes 15-18',
    time: 'Hands-on time 20 min, oven time 50 min, plus chilling and cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration'],
    cuisine: 'american',
    description:
      'Make your mum these lemony, flower-topped St Clement’s shortbreads to serve as afternoon tea on Mother’s Day. They’re simple but delectable: a soft shortbread-like base with a zingy citrus topping melding into it – a glorious bake for Mothering Sunday, Easter (or any day).',
    ingredients: [
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/17.jpg',
  },
  //Caramelised white chocolate, burnt butter and tahini cake////////////////////
  {
    ...
    difficulty: 'A challenge',
    portion: 'Serves 20',
    time: 'Hands-on time 1 hour 40 min, oven time 1 hour 20-25 min, plus chilling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'american',
    description:
      'Bake John Whaite’s epic white chocolate, burnt butter and tahini celebration cake to really impress your guests or celebrate a birthday.',
    ingredients: [
    ...
    method: [
      ...
      {
        'Step 6':
          'For the chocolate topping, put the chocolate, syrup and butter in a small heatproof bowl and stir, set over a pan of barely simmering water (don’t let the water touch the bowl). When melted and combined, leave to cool for 2 minutes, then pour over the top of the chilled cake so some dribbles down over the edge. Leave at room temperature. ',
      },
      {
        'Step 7':
          'Fill the piping bag with the rest of the buttercream and pipe 11 generous blobs around the top of the cake. Smash the brittle into shards of different shapes and sizes, then arrange 11 of them on top of the cake, leaning against the blobs of buttercream. Enjoy the remaining brittle shards with ice cream.',
      },
    ],
    image: 'https://apipics.s3.amazonaws.com/cakes_api/18.jpg',
  },
  //Eric Lanlard’s carrot and pumpkin celebration cake////////////////////
  {
    id: '19',
    title: 'Eric Lanlard’s carrot and pumpkin celebration cake',
    difficulty: 'Medium',
    portion: 'Serves 24',
    time: 'Hands-on time 40 min, Oven time 20-25 min, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'american',
    description:
    ...
    method: [
      {
        'Step 1':
          'Heat the oven to 180°C/160°C fan/gas 4. Sift the flour, sugars, bicarb and cinnamon into a large bowl. In a smaller bowl, whisk the oil, eggs, milk, ginger and vanilla.',
      },
      {
        'Step 2':
          'Add the oil mixture, orange zest, grated carrot and pumpkin puréeto the dry ingredients, then stir with a wooden spoon or spatula until almost combined. Add the chopped nuts and sultanas, then stir into the batter until just combined (see food team’s tips).',
      },
      {
        'Step 3':
          'Divide the batter evenly among the tins. Bake for 20-25 minutes until the tops are cracked and springy to the touch. Cool in the tins for 10 minutes, then invert onto a wire rack to cool completely (see Make Ahead).',
      },
      {
        'Step 4':
          'For the caramelised nuts, toast the nuts in a dry frying pan until golden, then tip onto the greased baking sheet to cool. Wipe out the pan, then add the sugar and heat until melted. Bring to the boil and simmer until a deep amber colour. Immediately (and carefully) pour over the toasted nuts to coat. Set aside to cool (see food team’s tips).',
      },
      {
        'Step 5':
          'For the frosting, beat together all the ingredients, adding enough icing sugar to make a thick, smooth mix – don’t overmix. Roughly chop the cooled nuts.',
      },
      {
        'Step 6':
          'To assemble, put one cake on a cake stand and spread with an even layer of frosting. Top with another cake and frosting, then repeat until all 4 cakes are stacked up. Cover the top and sides with the remaining frosting, then decorate with caramelised nuts. Add candles/sparklers if you want to. Happy birthday!',
      },
    ],
    image:
      'https://celebratingsweets.com/wp-content/uploads/2014/11/Pumpkin-Carrot-Cake-4.jpg',
  },
  //Tunnock’s teacake traybake////////////////////
  {
    id: '20',
    title: 'Tunnock’s teacake traybake',
    difficulty: 'Easy',
    portion: 'Serves 16',
    time: 'Hands-on time 25 min, Oven time 25 min',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'French',
    description:
    ...
    method: [
      ...
      {
        'Step 3':
          'Put all the meringue ingredients in a large heatproof bowl set over a panof simmering water (don’t let the bowl touch the water). Using an electric hand mixer, whisk the mixture for 6-8 minutes until thickened – the mixture must be very stiff to hold its shape. Spoon over the cooled biscuit base.',
      },
      {
        'Step 4':
          'Leave the meringue to set, then pour over the melted chocolate, smoothingit over with the back of a spoon. Leave in a cool place to set, then use a hot sharp knife to cut into 16 rectangles.',
      },
    ],
    image: 'https://apipics.s3.amazonaws.com/cakes_api/20.jpg',
  },
...

  {
    ...
    difficulty: 'Easy',
    portion: 'Makes 12',
    time: 'Hands-on time 20 min, oven time 20-25 min',
    type: 'oven',
    category: ['dessert', 'cupcakes', 'cake', 'holidays', 'sweets and treats'],
    cuisine: 'american',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/21.jpg',
  },
  //Chocolate cupcakes////////////////////
  {
    id: '22',
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/22.jpg',
  },
  //Orange blossom, lemon thyme and almond cake////////////////////
  {
    id: '23',
    title: 'Orange blossom, lemon thyme and almond cake',
    difficulty: 'Easy',
    portion: 'Serves 12',
    time: 'Hands-on time 25 min, cooking time 30 min, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'American',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/23.jpg',
  },
  //Eton mess traybake'////////////////////
  {
    id: '24',
    title: 'Eton mess traybake',
    difficulty: 'Easy',
    portion: 'Serves 12-15',
    time: 'Hands-on time 20 min, oven time 25-30 min',
    type: 'oven',
    ...
    method: [
      ...
      {
        'Step 2':
          'Spoon the mixture into the prepared tin and level the surface. Scatter the 250g prepared strawberries over the top and sprinkle with the granulatedsugar. Bake for 25-30 minutes until a skewer pushed into the centre of the cake comes out clean.',
      },
      {
        'Step 3':
          'Remove the cake from the oven and leave to cool in the tin for 10 minutes. Transfer to a cooling rack, leaving the baking paper in place, and leave to cool completely.',
      },
      {
        'Step 4':
          'To assemble, peel off the baking paper, then transfer the sponge to a serving plate. Whip the 250ml cream and icing sugar in a large mixing bowl until the cream forms soft peaks. Thickly spread the whipped cream on top of the sponge and scatter with the crumbled meringues, strawberries and mint leaves. Cut into even portions to serve.',
      },
    ],
    image: 'https://apipics.s3.amazonaws.com/cakes_api/24.jpg',
  },
  //Nut-free carrot cupcakes'////////////////////
  {
    id: '25',
    title: 'Nut-free carrot cupcakes',
    difficulty: 'Easy',
    portion: 'Makes 22',
    time: 'Hands-on time 20 min, oven time 20-22 min, plus cooling',
    type: 'oven',
    category: [
      'dessert',
      'cupcakes',
    ...
    ingredients: [
      ...
      '100g icing sugar',
      'Sugar flowers (from the baking aisle of larger supermarkets orat squires.co.uk) ',
    ...
    image:
      'https://chocolatecoveredkatie.com/wp-content/uploads/2021/09/Gluten-Free-Carrot-Cake-Cupcake-Recipe.jpg',
  },
  //Strawberry and rose victoria sponge sandwich'////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 8-10',
    time: 'Hands on time 30 mins, 30 mins to cook, plus cooling',
    type: 'oven',
    category: [
      'dessert',
      'cake',
    ...
    image:
      'https://sarahshealthykitchen.com/wp-content/uploads/2020/05/lemon-and-raspberry-cake-24.jpg',
  },
  //Strawberry and rose victoria sponge sandwich'////////////////////
  {
    id: '27',
    title: 'Strawberry and rose victoria sponge sandwich',
    difficulty: 'Easy',
    portion: 'Serves 12',
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/27.jpg',
  },
  //Toffee ice-cream cake'////////////////////
  {
    id: '28',
    title: 'Toffee ice-cream cake',
    difficulty: 'Easy',
    portion: 'Serves 10',
    ...
    cuisine: 'American',
    description:
      'This ice cream cake is decadent but light at the same time, easy to prepare and perfect for your backyard summer barbecues',
    ingredients: [
      '100g golden syrup',
      '100g caster sugar',
      '1 tsp bicarbonate of soda',
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/28.jpg',
  },
  //Easy flourless chocolate cake////////////////////
  {
    id: '29',
    title: 'Easy flourless chocolate cake',
    difficulty: 'Easy',
    portion: 'Serves 10',
    time: 'Hands-on time 20 min, oven time 40 minutes, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'American',
    description:
    ...
    method: [
      {
        'Step 1':
          'Heat the oven to 180°C/160° fan/gas 4. Gently melt the chocolate and butter in a heavy-based saucepan, then stir in 100g of the sugar. Leave to cool slightly, then beat in the egg yolks and vanilla using a wooden spoon. Pour into a large mixing bowl.',
      },
      {
        'Step 2':
          'In a large, spotlessly clean bowl whisk the egg whites with an electric mixer until foamy, add the cream of tartar, then whisk until stiff peaks form when the beaters are removed. Whisk in the remaining sugar, 1 tbsp at a time, until thick and glossy.',
      },
      {
        'Step 3':
          'Mix a spoonful of egg white into the choc mixture to loosen it, then fold in the remaining whites in 2-3 additions. Using a large metal spoon and a figure-of-eight motion, scrape the sides of the bowl, then fold the mix over on top of itself, giving the bowl a quarter-turn each time. Scrape the bottom of the bowl too after each turn to incorporate all the mixture.',
      },
      {
        'Step 4':
          'Spoon the batter into the prepared tin, then bake for 40 minutes or until risen and the top starts to crack. Cool the cake in the tin. Serve warm or at room temperature with ice cream.',
      },
    ],
    image: 'https://apipics.s3.amazonaws.com/cakes_api/29.jpg',
  },
  //Sticky toffee pudding cake////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 16',
    time: 'Hands-on time 1 hour 10 min, oven time 30-35 min, plus chilling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'American',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/30.jpg',
  },
  //Frozen lemon and blueberry mousse cake////////////////////
  {
    id: '31',
    title: 'Frozen lemon and blueberry mousse cake',
    difficulty: 'Easy',
    portion: 'Serves 8-10',
    time: 'Hands-on time 40 min, oven time 20-25 min, plus freezing',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'American',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/31.jpg',
  },
  //Secret-ingredient chocolate bundt cake////////////////////
  {
    id: '32',
    title: 'Secret-ingredient chocolate bundt cake',
    difficulty: 'Easy',
    portion: 'Makes a 25cm cake',
    time: 'Hands-on time 25 mins, oven time 50 mins',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'American',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/32.jpg',
  },
  //White forest gateau////////////////////
  {
    id: '33',
    title: 'White forest gateau',
    difficulty: 'Medium',
    portion: 'Serves 12',
    time: 'Hands-on time 40 min, oven time 35 min, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'American',
    description:
  ...
  //Ginger and honey biscuit cake with choc-orange icing////////////////////
  {
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/34.jpg',
  },
  //Giant Jaffa cake////////////////////
  {
    id: '35',
    ...
    difficulty: 'Medium',
    portion: 'Serves 12',
    time: 'Hands-on time 50 min, oven time 20-25 min, plus chilling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'French',
    description:
    ...
    image:
      'https://realfood.tesco.com/media/images/RFO-1400x919-Jaffa-mini-ee6d5319-e486-47c9-ab02-625a79e88cfb-0-1400x919.jpg',
  },
  //Eric Lanlard’s clementine and pomegranate cake (gluten-free)////////////////////
  {
    id: '36',
    title: 'Eric Lanlard’s clementine and pomegranate cake (gluten-free)',
    difficulty: 'Easy',
    portion: 'Serves 12',
    time: 'Preparation time 25 mins, plus cooling and cooking time 2-2½',
    type: 'oven',
    category: [
      'dessert',
      'cake',
    ...
    cuisine: 'French',
    description:
      'Eric Lanlard’s gluten-free clementine cake is made with ground almonds and steeped in syrup for a seriously moist texture. Top with pomegranate seeds for a bejewelled effect and serve – it makes an excellent alternative to Christmas cake.',
    ingredients: [
      ...
      '1 tsp vanilla bean paste',
      '3 tbsp apricot jam to make a glaze',
    ...
    method: [
      ...
      {
        'Step 5':
          'To make the apricot glaze, put the jam into a small saucepan and gently warm through, then press through a fine sieve to remove any lumps.',
      },
      {
        'Step 6':
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/36.jpg',
  },
  //Coconut and lime angel cake////////////////////
  {
    id: '37',
    title: 'Coconut and lime angel cake',
    difficulty: 'Easy',
    portion: 'Serves 12',
    time: 'Hands-on time 35 min, oven time 45-50 min, plus around 2 hours cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'fruits'],
    cuisine: 'American',
    description:
    ...
    image:
      'https://images-gmi-pmc.edge-generalmills.com/23478fb7-86cd-430f-965b-8b2323d3ab94.jpg',
  },
  //Daim bar layer cake////////////////////
  {
    id: '38',
    title: 'Daim bar layer cake',
    difficulty: 'Medium',
    portion: 'Serves 20',
    time: 'Hands-on time 1 hour 45 min, oven time 40 min, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration', 'chocolate'],
    cuisine: 'French',
    description:
    ...
    method: [
      {
        'Step 1':
          'Heat the oven to 180°C/160°C fan/gas 4. Put the butter and muscovado sugar in a mixing bowl and whisk with an electric mixer until pale, light and fluffy. Beat in the eggs, a little at a time, incorporating each addition before adding the next. Beat in the vanilla, then beat in the almonds, flour and baking powder with a pinch of salt until smooth.',
      },
      {
        'Step 2':
          'Divide the mix evenly between the prepared tins, level the tops, then bake for 40 minutes until risen, springy and golden. Remove from the oven, cool in the tin for 10 minutes, then carefully remove and leave to cool on wire racks.',
      },
      {
        'Step 3':
  ...
  // Elderflower, lemon and cherry cream flourless cake////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 10',
    time: 'Hands-on time 30 min, oven time 60-65 min, plus cooling',
    type: 'oven',
    category: [
      'dessert',
      'cake',
    ...
    image:
      'https://www.inlovewithcake.com/wp-content/uploads/2020/06/Mousse-ciliegia-e-fiori-di-sambuco-3ph-1546x2000.jpg',
  },
  // Chetna Makan’s pistachio, cardamom and white chocolate cake////////////////////
  {
    id: '40',
    title: 'Chetna Makan’s pistachio, cardamom and white chocolate cake',
    difficulty: 'Easy',
    portion: 'Serves 12',
    time: 'Hands-on 20 min, oven 30 min',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'celebration'],
    cuisine: 'French',
    description:
      'Chetna Makan’s combines the flavours of pistachio, cardamom and white chocolate to make the lightest of cakes that’s perfect served for afternoon tea or part of an Easter spread.',
    ingredients: [
    ...
    image:
      'https://www.deliciousmagazine.co.uk/wp-content/uploads/2018/07/673595-1-eng-GB_chetna-makan-white-chocolate-pistachio-and-cardamom-cake-768x960.jpg',
  },
  // Simple buttercream icing////////////////////
  {
    id: '41',
    title: 'Simple buttercream icing',
    difficulty: 'Easy',
    portion: 'Makes enough for one large cake',
    time: 'Hands-on time 5 minutes',
    type: 'icing',
    category: ['cream', 'buttercream', 'icing'],
    cuisine: 'American',
    description:
      'A quick and easy buttercream icing recipe – made with icing sugar, butter and cream cheese – to use on cupcakes, fairy cakes or birthday cakes.',
    ingredients: [
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/41.jpg',
  },
  // Chocolate porter cake////////////////////
  {
    id: '42',
    title: 'Chocolate porter cake',
    difficulty: 'Easy',
    portion: 'Serves 12-16',
    time: 'Hands-on time 30 min, oven time 1 hour, plus cooling',
    description:
    ...
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'chocolate', 'celebration'],
    cuisine: 'American',
    ingredients: [
    ...
    image:
      'https://www.deliciousmagazine.co.uk/wp-content/uploads/2018/09/porter-cake-768x960.jpg',
  },
  // Triple-chocolate layer cake////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 24',
    time: 'Takes 1 hour to make, 20-25 minutes to cook, plus cooling and chilling',
    description:
      'This chocolate layer cake recipe is made with three layers of chocolate and soured cream sponge filled with a fluffy chocolate buttercream and coated in an unsweetened chocolate mousse icing.',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'chocolate', 'celebration'],
    cuisine: 'American',
    ingredients: [
      ...
      '2 gelatine leaves',
      '500g double cream',
      '300g dark chocolate (Lizzie used Willie’s Cacao Madagascan 71), broken into pieces',
      'Hundreds and thousands and a 30cm acetate sheet to decorate',
      '175g unsalted butter, softened',
      '300g icing sugar',
      '100g dark chocolate (Lizzie used Willie’s Cacao Indonesian 69), melted as in step 1',
    ],
    method: [
      {
        'Step 1':
  ...
  // Chocolate cola cake////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 12-16',
    time: 'Hands-on time 45 min, oven time 25-35 min, plus chilling and cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'chocolate', 'celebration'],
    cuisine: 'American',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/44.jpg',
  },
  // Gluten-free chocolate cake with raspberries////////////////////
  {
    id: '45',
    title: 'Gluten-free chocolate cake with raspberries',
    difficulty: 'Easy',
    portion: 'Serves 8',
    time: 'Hands-on time 30 min; oven time 15 min, plus cooling',
    type: 'oven',
    category: [
      'dessert',
      'cake',
    ...
    cuisine: 'American',
    description:
      'We teamed up with Doves Farm to bring you this gluten-free chocolate cake recipe made with potato flour and topped with a rich chocolate icing and raspberries.',
    ingredients: [
      '75g potato flour',
      '25g cocoa',
      '2tsp baking powder',
    ...
    image:
      'https://i1.wp.com/sisterssansgluten.com/wp-content/uploads/2020/09/chocolate1.jpg?fit=719%2C1080&ssl=1',
  },
  // Pop cakes////////////////////
  {
    id: '46',
    ...
    difficulty: 'Easy',
    portion: 'Makes 12',
    time: 'Hands-on time 25 min, oven time 25-30min, plus cooling and at least 6 hours freezing',
    type: 'oven',
    category: [
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/46.jpg',
  },
  // Mary Berry’s malted chocolate cake////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 8-10',
    time: 'Takes 20 min to prepare, 25-30 min to bake, plus cooling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'chocolate', 'celebration'],
    cuisine: 'American',
    description:
    ...
    image:
      'https://www.maryberry.co.uk/media/recipes/2017/10/27/107_thumbnail.jpg',
  },
  // Chocolate celebration layer cake////////////////////
  {
    id: '48',
    title: 'Chocolate celebration layer cake',
    difficulty: 'Easy',
    portion: 'Serves 22-24',
    time: 'Takes 1 hour 15 minutes to make, 1 hour 10 minutes to cook',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'chocolate', 'celebration'],
    cuisine: 'American',
    description:
    ...
    image:
      'https://assets-eu-01.kc-usercontent.com/559bb7d3-88a4-01c1-79a3-dd4d5b2d2bb0/d7251d6a-d318-41dc-9745-9a3a737b4dcd/Chocolate%20Celebration%20Cake_Landscape-12.jpg',
  },
  // Apple caramel layer cake////////////////////
  {
    id: '49',
    title: 'Apple caramel layer cake',
    difficulty: 'Easy',
    portion: 'Serves 12-16',
    time: 'Takes 45 minutes to make, 1 hour to cook',
    type: 'oven',
    category: [
      'dessert',
      'cake',
    ...
    cuisine: 'American',
    description:
      'Three moist, apple sponges are layered together with caramelised apples, salted caramel sauce and Greek yogurt. This celebration layer cake is utter bliss. Watch our how-to video below.',
    ingredients: [
      '4 cox apples',
      ...
      '50g caster sugar',
      '70g unsalted butter',
      '350ml thick full fat Greek yogurt (we like Total Full Fat)',
      '75g unsalted butter',
    ...
    image:
      'https://bakerstable.net/wp-content/uploads/2021/10/caramel-apple-layer-cake-45-e1634915676790.jpg',
  },
  // Red velvet cake////////////////////
  {
    id: '50',
    ...
    difficulty: 'Medium',
    portion: 'Serves 20-24',
    time: 'Hands on time 40 min, oven time 40 min',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'valentines', 'celebration'],
    cuisine: 'American',
    description:
    ...
    method: [
      {
        'Step 1':
          'To make the sponges, preheat the oven to 180°C/fan160°C/gas 4, then grease, dust with flour and base-line 3 x 20cm loose-bottomed cake tins. In a large mixing bowl, cream the butter and caster sugar together with an electric hand whisk for 5 minutes or until pale and fluffy. Add the vanilla and the egg yolks, one at a time, beating well after each addition.',
      },
      {
        'Step 2':
          'In a second large mixing bowl, combine the flour, cornflour, baking powder and cocoa. In a third bowl, mix the buttermilk with the red food colouring. Sift a third of the dry ingredients into the butter mixture, then pour in a third of the buttermilk and mix together until just combined. Repeat this process with the remaining dry ingredients and buttermilk.',
      },
      {
        'Step 3':
          'In a large, clean bowl, whisk the egg whites with a pinch of salt until they form fairly firm peaks. Add to the cake mixture, a quarter at a time, folding gently with a large metal spoon until just incorporated.',
      },
      {
        'Step 4':
          'In a small bowl, mix the vinegar and bicarbonate of soda until it bubbles. Gently fold into the cake mixture, then quickly pour into the tins and smooth the tops. Bake for 40 minutes or until a skewer pushed into the middle of each sponge comes out clean.',
      },
      {
        'Step 5':
          'Leave the cakes to cool in the tins for 10 minutes, then turn out onto wire racks to cool completely. Cut each sponge in half horizontally to create 6 rounds (see tips).',
      },
      {
        'Step 6':
          'To make the frosting, whip the cream in a large bowl until you have medium-firm peaks, then set aside. In a separate bowl, beat the cream cheese, mascarpone and icing sugar together until stiff, then fold through the whipped cream.',
      },
      {
        'Step 7':
          'To assemble the cake, put a sponge on a platter and spread with a layer of frosting. Top with a second sponge, then repeat until all 6 sponges are layered with frosting. Use the remaining frosting to cover the top and sides of the cake, smoothing with a palette knife as you go. Finally, (OPTIONAL)decorate the top with white chocolate holly leaves and gold sugared almonds. Chill the cake for a few hours before slicing; it will keep in the fridge for four days.',
      },
    ],
    image:
  ...
  // Paul Hollywood’s ultimate carrot cake////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 8',
    time: 'Takes 20 minutes to make, 1 hour to cook',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'fruits', 'celebration'],
    cuisine: 'American',
    description:
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/51.jpg',
  },
  // Mary Berry’s very best chocolate and orange cake////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'Serves 8',
    time: 'Takes 20 minutes to make, 20-25 minutes to cook, plus cooling',
    type: 'oven',
    category: [
      'dessert',
      'cake',
    ...
    image: 'https://apipics.s3.amazonaws.com/cakes_api/52.jpg',
  },
  // Classic sponge cake////////////////////
  {
    id: '53',
    ...
    difficulty: 'Easy',
    portion: 'makes 12 servings',
    time: 'takes 50 mins to make, 30 mins to cook, plus coolling',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'sponge', 'celebration'],
    cuisine: 'Ukrainian',
    description:
    ...
    ingredients: [
      ...
      '1 Tbsp hot water',
      '1 tsp vanilla extract US Customary – Metric',
    ],
    method: [
      {
        'Step 1':
      ...
      {
        'Step 4':
          'Sift 1 cup all-purpose flour and 1 tsp baking powder, twice.',
      },
      {
        'Step 5':
          ' In a cup whisk together 2 TBSP melted butter, 1 TBSP hot water and 1 tsp of vanilla extract.',
      },
      {
        'Step 6':
          'Add the dry ingredients into the whipped eggs in halves, carefully folding with a spatula forming the number 8 with each stroke. Do not overfold or the cake will be dense and doughy. Just fold enough to barely incorporate the flour.',
      },
      {
        'Step 7':
      ...
      {
        'Step 8':
          'Pour the sponge cake batter into the prepared baking pan. Bake for about 35 minutes or until a toothpick inserted into the center comes out clean. Do not open the oven to check until you can smell cake in the kitchen (~30 min)',
      },
      {
        'Step 9':
      ...
      {
        'Step 10':
          'For best results wrap the cooled cake in plastic and leave on the counter for 6-8 hours before using in a cake. This will reduce the amount of crumbling when you split the cake layer in two horizontally.',
      },
    ],
    image:
      'https://preppykitchen.com/wp-content/uploads/2021/11/Chiffon-Cake-Feature.jpg',
  },
  // Gluten-free birthday cake sponge////////////////////
  {
    id: '54',
    title: 'Gluten-free birthday cake sponge',
    difficulty: 'Easy',
    portion: 'Serves 8 cake slice',
    time: 'Hands on time 20 min, oven time 25-30 min',
    type: 'oven',
    category: ['dessert', 'cake', 'holidays', 'fruits', 'celebration'],
    cuisine: 'american',
  ...
  // Ultimate chocolate mousse cake////////////////////
  {
    ...
    difficulty: 'Medium',
    portion: 'Serves 10-12',
    time: 'Takes 45 min to make, 45-50 min to cook, plus overnight chilling',
    type: 'oven',
    category: ['dessert', 'cake', 'chocolate', 'holidays', 'celebration'],
    cuisine: 'american',
    description:
      'A sumptuous, rich and moist chocolate cake recipe that’s great to serve at birthdays and celebrations – it’ll serve 10 to 12 guests. You can add a splash of Grand Marnier for a special twist, too.',
    ingredients: [
    ...
    method: [
      {
        'Step 1':
          'Preheat the oven to 180°C/fan 160°C/gas 4. Line the base of a 20cm springform cake tin with baking paper.',
      },
      {
        'Step 2':
          'For the cake, put the chocolate in a small bowl set over a pan of gently simmering water and melt slowly. Take off the heat, stir until smooth and set aside to cool slightly.',
      },
      {
        'Step 3':
          'Put the egg yolks and sugar in a bowl and beat with an electric whisk, until pale and thick. Keep whisking, adding the softened butter, a little at a time, then lower the whisk setting and whisk in the melted chocolate, then stir in the ground almonds.',
      },
      {
        'Step 4':
      ...
      {
        'Step 5':
          'Make the mousse. Lightly whip the cream and set aside. Melt the chocolate over a pan of gently simmering water. Beat in the egg yolks, then fold in the cream. Whisk the egg whites in a bowl to soft peaks, then fold into the chocolate mixture. Spoon over the cake layer in the tin, spreading it to the edges.',
      },
      {
        'Step 6':
          'Position the other cake layer cut-side down on top of the mousse and drizzle with the remaining liqueur, if using. Chill overnight.',
      },
      {
        'Step 7':
          'Remove the cake from the tin and put on a plate. For the icing, melt the chocolate, butter and icing sugar in a bowl over a pan of gently simmering water. Spoon over the top of the cake and let it drip slightly over the edges. Decorate with the rice flowers, if using, and serve cut into wedges.',
      },
    ],
    image:
      'https://www.alsothecrumbsplease.com/wp-content/uploads/2018/10/Chocolate-Mousse-Cake-4.jpg',
  },
  // Lavender cupcakes////////////////////
  {
    id: '56',
    ...
    difficulty: 'Easy',
    portion: 'Makes 12 cupcakes or 24 mini cupcakes',
    time: 'Takes 20 minutes to make, plus decorating',
    type: 'oven',
    category: [
      'dessert',
      'cupcakes',
    ...
    method: [
      ...
      {
        'Step 5':
          'FOR CREAM CHEESE FROSTING: Beat the cream cheese and butter together until creamy. Beat in the sugar until combined. Beat in the vanilla extract. Frost the cooled cupcakes! Before serving, top with fresh lavender springs or flowers. If desired, you can add a drop of food coloring in (pink or purple) to color the frosting!',
      },
    ],
    image:
      'https://eightforestlane.com/wp-content/uploads/2016/04/Lady-Grey-Cupcakes07_fi-500x366.jpg',
  },
  // Chocolate and berry traybake////////////////////
  {
    ...
    difficulty: 'Easy',
    portion: 'for lots of people',
    time: 'Takes 20 minutes to make, 45 minutes to bake, plus cooling',
    type: 'oven',
    category: ['dessert', 'cakes', 'chocolate', 'fruits', 'celebration'],
    cuisine: 'french',
    description:
      'A quick and easy chocolate birthday cake recipe made with frozen berries of your choice. A perfect choice for a child’s birthday party.',
    ingredients: [
    ...
    image:
      'https://www.deliciousmagazine.co.uk/wp-content/uploads/2018/08/515117-1-eng-GB_chocolate-and-berry-tray-bake.jpg',
  },
  // Easy coconut and chocolate cake ////////////////////
  {
    id: '58',
    title: 'Easy coconut and chocolate cake',
    difficulty: 'Easy',
    portion: 'Serves 16',
    time: 'Takes 30 minutes to make, 40 minutes to bake, plus cooling',
    type: 'oven',
    category: ['dessert', 'cakes', 'chocolate', 'fruits', 'celebration'],
    cuisine: 'american',
    description:
    ...
    image:
      'https://media-cldnry.s-nbcnews.com/image/upload/newscms/2019_18/1430813/elizabeth-karmel-main-190429-new.jpg',
  },
  // lemon and coconut cake ////////////////////
  {
    id: '59',
    title: 'Lemon and coconut cake',
    difficulty: 'Easy',
    portion: 'Serves 8',
    time: 'Takes 25 minutes to make, 25-30 minutes to bake, plus cooling',
    type: 'oven',
    description:
      'Good lemon curd gives this easy sponge cake recipe the edge. Bake it and enjoy for dessert or with an afternoon cuppa.',
    category: ['cakes', 'fruits', 'celebration', 'holidays'],
    cuisine: 'french',
    ingredients: [
      ...
      '100ml coconut cream',
      'Icing sugar, to dust',
      'Yellow primroses, optional, for decoration',
    ],
    method: [
      {
        'Step 1':
          'Preheat the oven to 180°C/fan160°C/gas 4. Grease and base line 2 x 18cm round sandwich cake tins with baking paper.',
      },
      {
        'Step 2':
          'Cream the butter, sugar and lemon zest together with an electric hand whisk. Gradually whisk in the coconut cream and eggs, adding 1 tablespoon flour to prevent it curdling. Sift in the remaining flour and the baking powder. Fold in until just combined.',
      },
      {
        'Step 3':
          'Divide the mixture equally between the tins, levelling the surfaces. Bake for 25-30 minutes, until golden. Cool in the tins for 15 minutes, before turning out onto a wire rack. Cool completely.',
      },
      {
        'Step 4':
          'Spread the lemon curd over the flat side of 1 cake, almost to the edge. Whisk the cream to soft peaks. Add the coconut cream and whisk again to soft peaks. Spoon on top of the curd and sandwich with the other cake. Chill to firm up the filling. Dust with icing sugar and decorate with primroses to serve.',
      },
    ],
    image: 'https://apipics.s3.amazonaws.com/cakes_api/59.jpg',
  },
  // 60 FRENCH MACARONS -------------------------------
  {
    id: '60',
    ...
    difficulty: 'Easy',
    portion: 'Makes 24-30 Macarons',
    time: 'Takes 45 min to make, 45-50 min to cook, plus overnight chilling',
    type: 'oven',
    description:
      'This easy French macaron recipe makes a batch of the most dainty, delicate, and delicious cookies that will float right into your mouth and disappear. Sandwiched around your favorite filling (jam, icing, ganache... Nutella?), these make a pretty, elegant dessert.',
    category: ['dessert', 'cookies', 'holidays', 'party', 'sweets and treats'],
    ...
    method: [
      ...
      {
        'Step 8':
          "Bake the first batch until the cookies are shiny and rise 1/8 inch to form a 'foot,' 12 to 14 minutes. Transfer to a rack to cool completely. Repeat, using a double sheet for each batch. Peel the cookies off the mats and sandwich with a thin layer of filling",
      },
      {
        'Step 9':
          '(Almond-Raspberry: Optional) Tint the batter with 2 drops neon pink gel food coloring; flavor with almond extract. For the filling, microwave 3 ounces chopped white chocolate, 2 tablespoons heavy cream and 1 tablespoon butter in 30-second intervals, stirring, until smooth. Stir in 1/4 teaspoon mint extract and 1 drop mint green gel food coloring.',
      },
    ],
    image:
  ...
  // 61 CLASSIC CUPCAKES -------------------------------
  {
    ...
    difficulty: 'Easy',
    portion: 'Makes 10-15 cupcakes',
    time: 'Takes 35 min to make, 15 min to cook, plus cooling',
    type: 'oven',
    description:
      'Ah the classic cupcake – an instant crowd pleaser, and one of the essentials to master on your baking journey!',
    category: ['dessert', 'cupcakes', 'cakes', 'party', 'sweets and treats'],
    cuisine: 'american',
    ingredients: [
      '200g unsalted butter, softened',
      '200g caster sugar',
    ...
    method: [
      ...
      {
        'Step 2': 'SLine a 12-hole cupcake tin with paper cases',
      },
      {
        'Step 3':
    ...
    image:
      'https://www.thecakedecoratingcompany.co.uk/blog/wp-content/uploads/2023/08/classic-cupcake-recipe-ingenious-edibles.png',
  },
  // 62 MOIST CHOCOLATE CUPCAKE-------------------------------
  {
    id: '62',
    title: 'Moist Chocolate Cupcakes with Ganache Filling',
    difficulty: 'Easy',
    portion: 'Makes 16-18 cupcakes',
    time: 'Takes 1 hour and 40 mins to make, 17 mins to cook, plus cooling',
    type: 'oven',
    description:
    ...
    method: [
      ...
      {
        'Step 4': 'Add the eggs one at a time, beating until combined',
      },
      {
        'Step 5':
      ...
      {
        'Step 8': 'Remove cupcakes from the oven and allow to cool',
      },
      {
        'Step 9':
          'To make the ganache filling, add the chocolate chips and vanilla extract to a medium sized bowl',
      },
      {
        'Step 10':
      ...
      {
        'Step 19':
          'Fill the centers of the cupcakes with the ganache filling (about a 1/2 tablespoon of ganache per cupcake), then pipe the frosting onto the cupcakes with the chocolate buttercream. I used Ateco tip 844. I also dusted the tops of the cupcakes with a little cocoa powder, if you’d like to do that.',
      },
      {
        'Step 20':
    ...
    image:
      'https://www.lifeloveandsugar.com/wp-content/uploads/2020/09/Chocolate-Cupcakes-with-Chocolate-Ganache-Filling2E.jpg',
  },
  // 63 PINA COLADA CUPCAKE-------------------------------
  {
    id: '63',
    title: 'Pina Colada Cupcakes',
    difficulty: 'Easy',
    portion: 'Makes 12-15 cupcakes',
    time: 'Takes 35 min to make, 15 min to cook, plus cooling',
    type: 'oven',
    description:
    ...
    method: [
      ...
      {
        'Step 3': ' Add sour cream and mix until well combined.',
      },
      {
        'Step 4':
      ...
      {
        'Step 5':
          'Combine dry ingredients in a separate bowl. Add half of the dry ingredients to the batter and mix until well combined. Add the pineapple juice and mix until well combined. Add remaining dry ingredients and mix until well combined.',
      },
      {
        'Step 6':
          'Stir in the crushed pineapple and scrape down the sides of the bowl as needed to be sure all ingredients are well incorporated',
      },
      {
        'Step 7':
      ...
      {
        'Step 10': 'Add about half of the powdered sugar and mix until smooth.',
      },
      {
        'Step 11':
          'Add the coconut extract, pineapple juice and coconut rum and mix until smooth.',
      },
      {
        'Step 12': 'Add the remaining powdered sugar and mix until smooth.',
      },
      {
        'Step 13':
          'Pipe the frosting on top of the cupcakes with a swirl. I used Ateco tip 808, a large round icing tip.',
      },
      {
        'Step 14':
          'To decorate the cupcakes, lightly press the coconut flakes onto the sides of the cupcakes then top them with a piece of pineapple and a cherry.',
      },
    ],
    image:
      'https://tmbidigitalassetsazure.blob.core.windows.net/rms3-prod/attachments/37/1200x1200/Pina-Colada-Cupcakes_EXPS_FT21_226958_F_0701_1.jpg',
  },
  // 64  UNICORN CUPCAKE -------------------------------
  {
    id: '64',
    ...
    difficulty: 'Easy',
    portion: 'Makes 12 cupcakes',
    time: 'Takes 4 hours, 15 min to cook, plus cooling',
    type: 'oven',
    description:
      "These cupcakes look impressive with their rainbow swirl, but they're actually really simple to make! They're the perfect colorful centerpiece for a party.",
    category: [
      'dessert',
      'cupcakes',
      'cakes',
    ...
    method: [
      {
        'Step 1':
          'Preheat the oven to 350 F. Line 1 (12-cup) standard muffin tin with cupcake liners.',
      },
      {
        'Step 2':
          'Make the cupcakes. In a medium bowl, combine the flour, baking powder, and salt.',
      },
      {
        'Step 3':
          'In another bowl, beat the eggs and sugar with an electric mixer until light and foamy, about 2 minutes. While beating, gradually pour in the melted butter followed by the vanilla.',
      },
      {
        'Step 4':
          'Working in batches, alternately add the flour mixture and the milk to the egg mixture. Do not overmix. ',
      },
      {
        'Step 5':
          'Divide the batter evenly into each cup of the prepared muffin tin. Bake for 18 to 20 minutes or until a cake tester inserted into the center of the cupcakes comes out clean. ',
      },
      {
        'Step 6':
      ...
      {
        'Step 7':
          'To prepare the frosting, beat the softened butter until smooth. Add the powdered sugar and beat until no lumps remain. ',
      },
      {
        'Step 8':
      ...
      {
        'Step 9':
          'Place the frosting in a piping bag fitted with a large star tip. Pipe a few swirls of frosting on each cupcake. ',
      },
      {
        'Step 10': 'Decorate the cupcakes with pastel colored sprinkles.',
      },
      {
        'Step 11':
          'Place a few tablespoons of pink sanding sugar on a plate. Halve each marshmallow on the diagonal, then press the cut side in the sugar to coat.',
      },
      {
        'Step 12':
          'Press two marshmallow unicorn ears in place on each cupcake. Place a gold spiral candle between the marshmallow ears on each cupcake to become the unicorn horn. Serve.',
      },
    ],
    image:
      'https://www.thespruceeats.com/thmb/Jy0kZyOBr3pBVcKJ1aV3ESzjl04=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/UnicornCupcakesHERO-30b2fd66a8db4a50b90129c402aa25c4.jpg',
  },
  // 65  STRAWBERRY CUPCAKE -------------------------------
  {
    id: '65',
    title: 'Strawberry Cupcakes',
    difficulty: 'Easy',
    portion: 'Makes 25 cupcakes',
    time: 'Takes 30 min to make, 15 min to cook, plus cooling',
    type: 'oven',
    description:
    ...
    ingredients: [
      ...
      '½ cup milk',
      '¾ cup pureed ripe strawberries (You can go ahead and make the puree for the frosting at this time also, and just set aside the 3 tablespoons of puree for late',
      'Fresh Strawberries, halved (optional for decoration)',
      {
        frosting: [
    ...
    method: [
      ...
      {
        'Step 6':
          'FOR THE STRAWBERRY WHIPPED CREAM FROSTING: Freeze your mixing bowl and beaters 10-15 minutes before whipping the cream). ',
      },
      {
        'Step 7':
      ...
      {
        'Step 11':
          'FOR DECORATION: We swirled the frosting onto our cooled cupcakes, using a large star piping tip (1M). We topped each cupcake with fresh strawberries, halved',
      },
    ],
    image:
      'https://preppykitchen.com/wp-content/uploads/2022/07/Strawberry-Cupcakes-Recipe-Card.jpg',
  },
  // 66  OREO CUPCAKE -------------------------------
  {
    id: '66',
    title: 'Oreo Cupcakes',
    difficulty: 'Easy',
    portion: 'Makes 28 cupcakes',
    time: 'Takes 45 min to make, 18 min to cook, plus cooling',
    type: 'oven',
    description:
    ...
    category: ['dessert', 'cupcakes', 'chocolate', 'sweets and treats'],
    cuisine: 'american',
    ingredients: [
    ...
    method: [
      ...
      {
        'Step 11':
          'FOR THE OREO BUTTERCREAM: Crush Oreos and set aside. (We used 10 Oreos, adjust amount to your liking).',
      },
      {
        'Step 12':
      ...
      {
        'Step 16': 'Fold Oreos into the buttercream.',
      },
      {
        'Step 17': 'This recipe can be doubled or halved.',
      },
      {
        'Step 18': 'Yields approximately 4 ½ cups of frosting.',
      },
      {
        'Step 19': 'Once the cupcakes have cooled, frost the cupcakes.',
      },
      {
        'Step 20':
      ...
      {
        'Step 21': 'We topped each cupcake with a mini Oreo.',
      },
    ],
    image:
      'https://preppykitchen.com/wp-content/uploads/2017/12/Oreo-cupcake-recipe-final-1b.jpg',
  },
  // 67  BLEUEBERRY COCONUT CUPCAKE -------------------------------
  {
    id: '67',
    title: 'Blueberry Coconut Cupcakes',
    difficulty: 'Easy',
    portion: 'Makes 16 cupcakes',
    time: 'Takes 1 hour to make, 18 mins to cook, plus cooling',
    type: 'oven',
    description:
    ...
    method: [
      ...
      {
        'Step 4': 'Add the egg whites and mix until well combined.',
      },
      {
        'Step 5': 'Add the sour cream and mix until well combined.',
      },
      {
        'Step 6': 'Add the milk and mix until well combined. ',
      },
      {
        'Step 7':
      ...
      {
        'Step 15': 'Pipe the frosting onto the cupcakes. I used Ateco tip 847.',
      },
      {
        'Step 16':
    ...
    image:
      'https://www.lifeloveandsugar.com/wp-content/uploads/2022/06/Blueberry-Coconut-Cupcakes3.jpg',
  },
  // 68  PEANUT BUTTER CUPCAKE -------------------------------
  {
    id: '68',
    title: 'Peanut Butter Cupcakes',
    difficulty: 'Easy',
    portion: 'Makes 12 cupcakes',
    time: 'Takes 25 mins to make, 15 mins to cook, plus cooling',
    type: 'oven',
    description:
    ...
    category: ['dessert', 'cupcakes', 'cakes', 'sweets and treats'],
    cuisine: 'american',
    ingredients: [
      '1 1/4 cups (163g) all-purpose flour',
      '1 tsp baking powder',
    ...
    method: [
      ...
      {
        'Step 12': 'Add the peanut butter and mix until well combined.',
      },
      {
        'Step 13':
    ...
    image:
      'https://www.justsotasty.com/wp-content/uploads/2017/09/Peanut-Butter-Cupcakes-3-1.jpg',
  },
  // 69  MINT CHOCOLATE CHIP CUPCAKE -------------------------------
  {
    id: '69',
    title: 'Mint Chocolate Chip Cupcakes',
    difficulty: 'Easy',
    portion: 'Makes 14 cupcakes',
    time: 'Takes 20 mins to make, 18 mins to cook, plus cooling',
    type: 'oven',
    description:
    ...
    method: [
      ...
      {
        'Step 11': 'Add 2 cups of powdered sugar and mix until smooth',
      },
      {
        'Step 12':
          'Add the vanilla and mint extracts and 1 tablespoon of water or milk and mix until smooth.',
      },
      {
        'Step 13': 'Add remaining powdered sugar and mix until smooth.',
      },
      {
        'Step 14':
      ...
      {
        'Step 15':
          'Pipe the frosting onto the cupcakes. I used a large round tip to pipe frosting evenly on to the top, then smoothed the top and sides with an offset spatula',
      },
      {
        'Step 16':
          'Add mini chocolate chips to a small bowl (or hold some in your hand) and dip the sides of the frosting into the chips so that they stick.',
      },
    ],
    image:
      'https://whitworths-sugar.co.uk/cdn/shop/articles/Mint_choc_chip_3960875e-f7fa-4da3-b94a-06fc68bfdd19_620x.jpg?v=1681826734',
  },
  // 70  SOFT CUT-OUT SUGAR COOKIES-------------------------------
  {
    id: '70',
    title: 'Soft Cut-Out Sugar Cookies',
    difficulty: 'Easy',
    portion: 'Makes 23 cookies',
    time: 'Takes 2 hours and 30 mins to make, 12 mins to cook, plus cooling',
    type: 'oven',
    description:
    ...
    image:
      'https://kathrynskitchenblog.com/wp-content/uploads/2022/01/Cut-Out-Sugar-Cookies-15-scaled.jpg',
  },
  // 71  CARAMEL APPLE COOKIE CUPS-------------------------------
  {
    id: '71',
    title: 'Caramel Apple Cookie Cups',
    difficulty: 'Easy',
    portion: 'Makes 18-20 cookies',
    time: 'Takes 1 hour to make, 10 mins to cook, plus cooling',
    type: 'oven',
    description:
    ...
    method: [
      ...
      {
        'Step 4': 'Add the egg and vanilla and beat until well combined.',
      },
      {
        'Step 5':
    ...
    image:
      'https://www.lifeloveandsugar.com/wp-content/uploads/2014/09/Caramel-Apple-Cookie-Cups2.jpg',
  },
  // 72  FUDGY BROWNIES-------------------------------
  {
    id: '72',
    title: 'My Best Fudgy Brownies Recipe',
    difficulty: 'Easy',
    portion: 'Makes 16 brownies',
    time: 'Takes 45 mins to make, 15 mins to cook, plus cooling',
    type: 'oven',
    description:
    ...
    category: ['bars and brownies', 'dessert', 'chocolate'],
    cuisine: 'american',
    ingredients: [
      '4 ounces (113 grams) dark chocolate (between 63% and 73% cocoa), from whole fèves or a high-quality chocolate bar, chopped into ½- to 1-inch pieces',
    ...
    method: [
      ...
      {
        'Step 3':
          'Whisk the eggs, sugars, and vanilla, then add the chocolate mixture and the flour and salt. In a medium bowl, whisk together the eggs, sugars, and vanilla. Slowly pour in the chocolate mixture while whisking. Sprinkle the flour and salt over the batter all at once and use a rubber spatula to mix until just combined.',
      },
      {
        'Step 4':
    ...
    image:
      'https://www.modernfarmhouseeats.com/wp-content/uploads/2021/03/Best-chewy-fudgy-brownies-105-scaled.jpg',
  },
  // 73  CHOCOLATE THUMBPRINT COOKIES-------------------------------
  {
    id: '73',
    title: 'Chocolate Thumbprint Cookies',
    difficulty: 'Easy',
    portion: 'Makes 28 Cookies',
    time: 'Takes 35 mins to make, 10 mins to cook, plus cooling',
    type: 'oven',
    description:
    ...
    method: [
      ...
      {
        'Step 4': 'Add the vanilla extract and mix until well combined.',
      },
      {
        'Step 5':
    ...
    image:
      'https://sugarspunrun.com/wp-content/uploads/2016/11/chocolate-thumbprint-cookies-10-of-13.jpg',
  },
  // 74  CHOCOLATE THUMBPRINT COOKIES-------------------------------
  {
    id: '74',
    title: 'Easy Anise Cookies',
    difficulty: 'Easy',
    portion: 'Makes 28 Cookies',
    time: 'Takes 1 hour and 10 mins to make, 10 mins to cook, plus cooling',
    type: 'oven',
    category: [
      'cookies',
      'dessert',
    ...
    method: [
      ...
      {
        'Step 4':
          'Add the eggs one at a time, mixing well after each addition. The batter will end up thin and curdled/separated.',
      },
      {
        'Step 5':
          'Add the milk and extracts and mix until well combined. The batter will still be thin and curdled/separated. ',
      },
      {
        'Step 6':
          'Add the flour and baking powder and mix until combined. Don’t over-mix. ',
      },
      {
        'Step 7':
          'Create balls of 1 1/2 tablespoons of cookie dough and place them on the prepared baking sheet. Bake for 10-15 minutes or until the cookies just look done and just before the bottoms begin to brown.',
      },
      {
        'Step 8': 'Place the cookies on a cooling rack to cool completely. ',
      },
      {
        'Step 9':
          'To make the icing, combine all of the ingredients in a small bowl and whisk together until well combined. If it seems too thin, you can add additional powdered sugar. If it seems too thick, add additional cream.',
      },
      {
        'Step 10':
          'To decorate the Cookies, Dip the tops of each cookie into the icing and allow the excess to drip off. Add your choice of sprinkles to the tops and allow them to dry.',
      },
    ],
    image:
      'https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_1:1/k%2FEdit%2F2022-10-Anise-Cookies%2Fanise-cookies-5',
  },
  // 75  EASTER EGG OREO COOKIE BALLS-------------------------------
  {
    id: '75',
    title: 'Easter Egg Oreo Cookie Balls',
    difficulty: 'Easy',
    portion: 'Makes 20-22 eggs',
    time: 'Takes 3 hours preparation',
    type: 'no bake',
    category: [
      'cake pops & cookie balls',
      'cookies',
    ...
    image:
      'https://www.lifeloveandsugar.com/wp-content/uploads/2021/03/Easter-Egg-Oreo-Cookie-Balls2.jpg',
  },
  // 76  BAILEYS IRISH CREAM COOKIE BALLS-------------------------------
  {
    id: '75',
    title: 'No Bake Baileys Irish Cream Cookie Balls',
    difficulty: 'Easy',
    portion: 'Makes 22 cookie balls',
    time: 'Takes 1 hour and 30 mins preparation',
    type: 'no bake',
    category: [
      'cake pops & cookie balls',
      'cookies',
    ...
    image:
      'https://www.lifeloveandsugar.com/wp-content/uploads/2013/03/No-Bake-Baileys-Irish-Cream-Cookie-Balls1.jpg',
  },
  // 76  RED VELVE CHEESECAKE POPS-------------------------------
  {
    id: '76',
    title: 'Red Velvet Cheesecake Pops',
    difficulty: 'Easy',
    portion: 'Makes 12',
    time: 'Takes 3 hours and 15 mins to make ,2 hours and 30 mins to cook, plus cooling.',
    type: 'oven',
    category: [
      'cake pops & cookie balls',
      'cookies',
    ...
    image:
      'https://princesspinkygirl.com/wp-content/uploads/2022/07/Red-Velvet-Cheesecake-Bites-41SQ1200.jpg',
  },
  // 77  REINDEER COOKIE BALLS-------------------------------
  {
    id: '77',
    title: 'Reindeer Cookie Balls',
    difficulty: 'Easy',
    portion: 'Makes 28-30',
    time: 'Takes 2 hours and 30 mins to make, 1 hour to cook, plus cooling.',
    type: 'no bake',
    category: [
      'cake pops & cookie balls',
      'cookies',
    ...
    method: [
      ...
      {
        'Step 2':
          ' Add the chopped pretzels to the crumbs and stir to combine.',
      },
      {
        'Step 3':
          'Mix together the cream cheese, cookie crumbs and pretzels until well combined. You should easily be able to form balls.',
      },
      {
        'Step 4':
          'Form balls from the cookie mixture about 1 inch in size. I used about 1 tablespoon of the mixture per ball.',
      },
      {
        'Step 5':
          'Put the balls in the fridge for about 1 hour to firm up a bit.',
      },
      {
        'Step 6':
          'While the balls chill, break the pretzels into halves for the antlers. You’ll want 28 pairs of antlers.',
      },
      {
        'Step 7':
          'Dip the chilled balls into the melted chocolate and set on parchment paper.',
      },
      {
        'Step 8':
          'Quickly add the pretzel antlers to the top of ball and hold them there for a few seconds until they stay in place.',
      },
      {
        'Step 9':
          ' Add the eyes and nose, using a little extra chocolate to attach them, if needed.',
      },
      {
        'Step 10':
          'Store cookie balls in the fridge. Cookie balls should be good for at least 1 week.',
      },
    ],

    image:
      'https://i0.wp.com/lmld.org/wp-content/uploads/2020/11/Reindeer-Cookie-Dough-Balls-3.jpg',
  },
  // 78  NO BAKE CHAMPAGNE COOKIE POPS-------------------------------
  {
    id: '78',
    title: 'No Bake Champagne Cookie Pops',
    difficulty: 'Easy',
    portion: 'Makes 24',
    time: 'Takes 15 mins to make',
    type: 'no bake',
    category: [
      'cake pops & cookie balls',
      'cookies',
    ...
    method: [
      ...
      {
        'Step 7': 'Dip each ball into the candy and tap off the excess.',
      },
      {
        'Step 8': 'Set on a piece of parchment paper to dry and add sprinkles.',
      },
      {
        'Step 9': 'Once dry, store pops in an air tight container.',
      },
    ],

    image:
      'https://www.lifeloveandsugar.com/wp-content/uploads/2017/02/Champagne-Cookie-Pops4.jpg',
  },
  // 79  FUDGY COOKIES AND CREAM BROWNIES-------------------------------
  {
    id: '79',
    title: 'Fudgy Cookies and Cream Brownies',
    difficulty: 'Easy',
    portion: 'Makes 18 brownies',
    time: 'Takes 55 minutes to make, 30 mins to cook, plus cooling',
    type: 'oven',
    category: [
      'bars and brownies',
      'dessert',
    ...
    method: [
      {
        'Step 1':
          'Preheat oven to 350 degrees Fahrenheit. Grease a 9×13 inch pan or line it with parchment paper that sticks up above the sides, which can be used to lift the finished brownies out of the pan and make cutting easier. Set pan aside.',
      },
      {
        'Step 2':
      ...
      {
        'Step 3': 'Add the sugar and whisk until combined.',
      },
      {
        'Step 4':
    ...
    image:
      'https://www.lifeloveandsugar.com/wp-content/uploads/2023/06/Cookies-and-Cream-Oreo-Brownies1E.jpg',
  },
  // 80  EASY TIRAMISU RECIPE-------------------------------
  {
    id: '80',
    title: 'Easy Tiramisu Recipe',
    difficulty: 'Easy',
    portion: 'Makes 12-14',
    time: 'Takes 45 minutes to make',
    type: 'no bake',
    category: [
      'bars and brownies',
      'dessert',
    ...
    method: [
      ...
      {
        'Step 4':
          'ASet the egg mixture aside to cool to a little warmer than room temperature.',
      },
      {
        'Step 5':
    ...
    image:
      'https://www.sandravalvassori.com/wp-content/uploads/2022/04/Tiramisu-11484.jpg',
  },
];
