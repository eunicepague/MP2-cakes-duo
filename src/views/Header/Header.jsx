        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link as={Link} to="/pastries" disabled={id ==null? true : false}>
                Cakes
              </Nav.Link>
...

            {
              id == null ? (
                ...
                <>
                  <Button variant="light" className="btn me-3" onClick={handleLogout}>
                    Logout
                  </Button>
                  <Button variant="light" className="btn" as={Link} to="/dashboard">
                    Dashboard
                  </Button>
                </>
              )
